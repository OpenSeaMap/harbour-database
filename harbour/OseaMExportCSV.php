        ...
        while (!feof($fp))
            {
                ...
                for($i=0; $i<9; $i++)
                {
                    ...
                    $champs0 = mysql_real_escape_string(mb_convert_encoding($liste[0],"UTF-8","UTF-8"),$conn); // id
                    $champs1 = mysql_real_escape_string(mb_convert_encoding($liste[1],"UTF-8","UTF-8"),$conn); // Name
                    $champs2 = mysql_real_escape_string(mb_convert_encoding($liste[2],"UTF-8","UTF-8"),$conn); // Descr
                    $champs3 = mysql_real_escape_string(mb_convert_encoding($liste[3],"UTF-8","UTF-8"),$conn); // Link
                    $champs4 = mysql_real_escape_string(mb_convert_encoding($liste[4],"UTF-8","UTF-8"),$conn); // lon
                    $champs5 = mysql_real_escape_string(mb_convert_encoding($liste[5],"UTF-8","UTF-8"),$conn); // lat
                    $champs6 = mysql_real_escape_string(mb_convert_encoding($liste[6],"UTF-8","UTF-8"),$conn); // coord
                    $champs7 = mysql_real_escape_string(mb_convert_encoding($liste[7],"UTF-8","UTF-8"),$conn); // type
                    $champs8 = mysql_real_escape_string(mb_convert_encoding($liste[8],"UTF-8","UTF-8"),$conn); // LID
...
$conn = DatabaseConnection($db_host, $db_user, $db_pw, $db_db);
